...
unlink ~/dotfiles/helix/themes/current.toml     ; ln -sf "$HOME/dotfiles/helix/themes/flow.toml"      ~/dotfiles/helix/themes/current.toml
unlink ~/dotfiles/nvim/lua/themes/current       ; ln -sf "$HOME/dotfiles/nvim/lua/themes/flow"        ~/dotfiles/nvim/lua/themes/current
